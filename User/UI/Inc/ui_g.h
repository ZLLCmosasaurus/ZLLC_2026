...
extern uint8_t ui_g_max_send_count[46];
...
#define ui_g_Ungroup_NewNumber ((ui_interface_number_t*)&(ui_g_now_figures[22]))
#define ui_g_Ungroup_NewArc ((ui_interface_arc_t*)&(ui_g_now_figures[23]))
#define ui_g_Ungroup_NewEllipse ((ui_interface_ellipse_t*)&(ui_g_now_figures[24]))
#define ui_g_Lift_Rect_Uplift_LF ((ui_interface_rect_t*)&(ui_g_now_figures[25]))
#define ui_g_Ungroup_NewFloat ((ui_interface_number_t*)&(ui_g_now_figures[26]))
#define ui_g_RobotStatus_Now_Power ((ui_interface_rect_t*)&(ui_g_now_figures[27]))
#define ui_g_RobotStatus_Now_RF ((ui_interface_rect_t*)&(ui_g_now_figures[28]))
#define ui_g_RobotStatus_Now_LF ((ui_interface_rect_t*)&(ui_g_now_figures[29]))
#define ui_g_RobotStatus_Now_RB ((ui_interface_rect_t*)&(ui_g_now_figures[30]))
#define ui_g_RobotStatus_Now_LB ((ui_interface_rect_t*)&(ui_g_now_figures[31]))
#define ui_g_Joint_Circle_J0 ((ui_interface_round_t*)&(ui_g_now_figures[32]))
#define ui_g_Joint_Circle_J2 ((ui_interface_round_t*)&(ui_g_now_figures[33]))
#define ui_g_Joint_Circle_J3 ((ui_interface_round_t*)&(ui_g_now_figures[34]))
#define ui_g_Joint_Circle_J4 ((ui_interface_round_t*)&(ui_g_now_figures[35]))
#define ui_g_Joint_Circle_J5 ((ui_interface_round_t*)&(ui_g_now_figures[36]))
...
#define ui_g_Ungroup_NewNumber_max_send_count (ui_g_max_send_count[22])
#define ui_g_Ungroup_NewArc_max_send_count (ui_g_max_send_count[23])
#define ui_g_Ungroup_NewEllipse_max_send_count (ui_g_max_send_count[24])
#define ui_g_Lift_Rect_Uplift_LF_max_send_count (ui_g_max_send_count[25])
#define ui_g_Ungroup_NewFloat_max_send_count (ui_g_max_send_count[26])
#define ui_g_RobotStatus_Now_Power_max_send_count (ui_g_max_send_count[27])
#define ui_g_RobotStatus_Now_RF_max_send_count (ui_g_max_send_count[28])
#define ui_g_RobotStatus_Now_LF_max_send_count (ui_g_max_send_count[29])
#define ui_g_RobotStatus_Now_RB_max_send_count (ui_g_max_send_count[30])
#define ui_g_RobotStatus_Now_LB_max_send_count (ui_g_max_send_count[31])
#define ui_g_Joint_Circle_J0_max_send_count (ui_g_max_send_count[32])
#define ui_g_Joint_Circle_J2_max_send_count (ui_g_max_send_count[33])
#define ui_g_Joint_Circle_J3_max_send_count (ui_g_max_send_count[34])
#define ui_g_Joint_Circle_J4_max_send_count (ui_g_max_send_count[35])
#define ui_g_Joint_Circle_J5_max_send_count (ui_g_max_send_count[36])

#define ui_g_RobotMode_RunningMode_max_send_count (ui_g_max_send_count[37])
#define ui_g_RobotMode_ControllerType_max_send_count (ui_g_max_send_count[38])
#define ui_g_RobotStatus_Orientation_max_send_count (ui_g_max_send_count[39])
#define ui_g_RobotStatus_none_max_send_count (ui_g_max_send_count[40])
#define ui_g_RobotStatus_FSM_Status_max_send_count (ui_g_max_send_count[41])
#define ui_g_Tips_Wheels_max_send_count (ui_g_max_send_count[42])
#define ui_g_RobotStatus_Wheel_Status_max_send_count (ui_g_max_send_count[43])
#define ui_g_Tips_Gripper_max_send_count (ui_g_max_send_count[44])
#define ui_g_RobotStatus_Gripper_Status_max_send_count (ui_g_max_send_count[45])
...
#define ui_g_Ungroup_NewNumber_dirty (ui_g_dirty_figure[22])
#define ui_g_Ungroup_NewArc_dirty (ui_g_dirty_figure[23])
#define ui_g_Ungroup_NewEllipse_dirty (ui_g_dirty_figure[24])
#define ui_g_Lift_Rect_Uplift_LF_dirty (ui_g_dirty_figure[25])
#define ui_g_Ungroup_NewFloat_dirty (ui_g_dirty_figure[26])
#define ui_g_RobotStatus_Now_Power_dirty (ui_g_dirty_figure[27])
#define ui_g_RobotStatus_Now_RF_dirty (ui_g_dirty_figure[28])
#define ui_g_RobotStatus_Now_LF_dirty (ui_g_dirty_figure[29])
#define ui_g_RobotStatus_Now_RB_dirty (ui_g_dirty_figure[30])
#define ui_g_RobotStatus_Now_LB_dirty (ui_g_dirty_figure[31])
#define ui_g_Joint_Circle_J0_dirty (ui_g_dirty_figure[32])
#define ui_g_Joint_Circle_J2_dirty (ui_g_dirty_figure[33])
#define ui_g_Joint_Circle_J3_dirty (ui_g_dirty_figure[34])
#define ui_g_Joint_Circle_J4_dirty (ui_g_dirty_figure[35])
#define ui_g_Joint_Circle_J5_dirty (ui_g_dirty_figure[36])
