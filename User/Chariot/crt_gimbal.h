 ...
 *
 */
class Class_Gimbal_Yaw_Motor_DJI3508 : public Class_DJI_Motor_C620
{
public:
    //陀螺仪获取云台角速度
    Class_IMU *IMU;
...
float Class_Gimbal_Yaw_Motor_DJI3508::Get_Trer_Rad_Yaw()
{
    return (True_Rad_Yaw);
} 

float Class_Gimbal_Yaw_Motor_DJI3508::Get_True_Gyro_Yaw()
{
    return (True_Gyro_Yaw);
}

float Class_Gimbal_Yaw_Motor_DJI3508::Get_True_Angle_Yaw()
{
    return (True_Angle_Yaw);
}
 ...
 *
 */
class Class_Gimbal_Pitch_Motor_DJI2006 : public Class_DJI_Motor_C610
{
public:
    //陀螺仪获取云台角速度
    Class_IMU *IMU;
...
float Class_Gimbal_Pitch_Motor_DJI2006::Get_True_Rad_Pitch()
{
    return (True_Rad_Pitch);
} 

float Class_Gimbal_Pitch_Motor_DJI2006::Get_True_Gyro_Pitch()
{
    return (True_Gyro_Pitch);
}

float Class_Gimbal_Pitch_Motor_DJI2006::Get_True_Angle_Pitch()
{
    return (True_Angle_Pitch);
}
/**
