...
public:
    ...
    inline float Get_Rx_Target_X();
    inline float Get_Rx_Target_Y();
    inline float Get_Rx_Target_Z();
...
float Class_MiniPC::Get_Rx_Target_X()
{
    return (Rx_Target_X);
}
float Class_MiniPC::Get_Rx_Target_Y()
{
    return (Rx_Target_Y);
}
float Class_MiniPC::Get_Rx_Target_Z()
{
    return (Rx_Target_Z);
}
/**
