...
public:
    ...
    inline float Get_Rx_Pitch_Gyro();
    inline float Get_Rx_Yaw_Gyro();
    inline float Get_Rx_Pitch_Acc();
    inline float Get_Rx_Yaw_Acc();
    ...
    void Convert_Radar_to_GunCoordinate(float radar_x, float radar_y, float radar_z, float *gun_x, float *gun_y, float *gun_z);
...
protected:
    ...
    float Rx_Angle_Roll;
    float Rx_Angle_Pitch; // 上位机发送目标pitch电机角度
    float Rx_Angle_Yaw; // 上位机发送目标yaw电机角度
    float Rx_Gyro_Yaw; // yaw电机目标速度
    float Rx_Gyro_Pitch; // pitch电机目标速度
    float Rx_Acc_Yaw; // yaw电机目标加速度
    float Rx_Acc_Pitch; // pitch电机目标加速度
...
float Class_MiniPC::Get_Rx_Pitch_Gyro()
{
    return (Rx_Gyro_Pitch);
}

float Class_MiniPC::Get_Rx_Yaw_Gyro()
{
    return (Rx_Gyro_Yaw);
}

float Class_MiniPC::Get_Rx_Pitch_Acc()
{
    return (Rx_Acc_Pitch);
}

float Class_MiniPC::Get_Rx_Yaw_Acc()
{
    return (Rx_Acc_Yaw);
}
 ...
 * @return uint8_t 
 */
inline uint8_t Class_MiniPC::Get_Lidar_if_Lob()
{
    return Lidar_if_Lob;
}
 ...
 * @brief 设定雷达部署命中可信度
 * 
 * @param __Lidar _Lob_Stability 
 */
void Class_MiniPC::Set_Lidar_Lob_Stability(uint8_t __Lidar_Lob_Stability)
{
    Lidar_Lob_Stability = __Lidar_Lob_Stability;
}
