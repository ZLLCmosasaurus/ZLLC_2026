...
public:
...
#endif
    //雷达云台控制
    Class_PID PID_Minipc_X;
    Class_PID PID_Minipc_Y;
    ...
    void TIM_Control_Gimbal_PeriodElapsedCallback();
...
protected:
    ...
    // 迷你主机云台pitch自瞄控制系数
    float MiniPC_Autoaiming_Yaw_Angle_Resolution = 0.015f;
    // 迷你主机云台pitch自瞄控制系数
    float MiniPC_Autoaiming_Pitch_Angle_Resolution = 1.f;
